...
### Added
- TypeScript v2 rewrite of PathRipper as ripperoni.
- Plugin-driven pipeline with TaskRegistry, PipelineState, ScrapeOrchestrator.
- Three-mode MediaWiki scraping: single category, categories[], or all-pages enumeration.
- AJV-validated configuration, structured error hierarchy, native git hooks.
