/**
 * Weapon, Armor, and Equipment output types and per-slice interfaces.
 *
 * ArmorOutput and EquipmentOutput are declared here and re-exported
 * so armor.ts and equipment.ts can import them. They are owned by those
 * respective concepts when fully split.
 */
import type { Rarity, PfsLegality, SourceRef, LinkRef, ActionCost } from '../../common.js';
