/**
 * Spell concept — type definitions.
 *
 * Defines all SpellOutput, slice interfaces, and per-slice data structures.
...
/** Fields owned by `extract-spell-outcomes`. */
export interface SpellOutcomesSlice {
  description_html: string;
  description_text: string;
  outcomes:         SpellOutcome;
}

/** Fields owned by `extract-spell-affliction`. */
export interface SpellAfflictionSlice {
  affliction:               Affliction | null;
  ritual_primary_check:     string | null;
  ritual_secondary_casters: number | null;
  ritual_secondary_checks:  string | null;
...
/** Fields owned by `extract-spell-heightened`. */
export interface SpellHeightenedSlice {
  heightened: HeightenedEntry[];
}

/** Fields owned by `extract-spell-meta`. */
