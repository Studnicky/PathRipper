...
export const ACTION_LABEL_MAP: ReadonlyMap<string, import('../../common.js').ActionCost> = new Map<string, import('../../common.js').ActionCost>([
...
export function parseActionCostFromHtml(html: string): import('../../common.js').ActionCost | null {
